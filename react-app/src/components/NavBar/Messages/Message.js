    ...
    <div className={`chat-message-${side}`} id="message-bar-chat-bar">
      <div id="message-bar-chat-bar" className="message">
        <div className="comment-body edit-area" id="message-bar-chat-bar">
          ...
          <textarea id="message-bar-chat-bar" maxLength='200' cols='20' rows={newMessage.split('\n').length > 2 ? newMessage.split('\n').length : 3} wrap="hard" value={newMessage} onChange={e => setNewMessage(e.target.value)} className='message-textarea'></textarea>
    ...
    <div className={`chat-message-${side}`} id="message-bar-chat-bar">
      <div id="message-bar-chat-bar" className="message">
        <div id="message-bar-chat-bar" className="message-mid">
          ...
          {owned && <div className="message-settings-button" id="message-bar-chat-bar" onClick={() => setShowEdit(!showEdit)}>⋮</div>}
        </div>
