...
const SINGLE_COMMENT = 'games/GET_SINGLE_COMMENT'
const CREATE_COMMENT = 'games/CREATE_COMMENT';
const CREATE_REPLY = 'games/CREATE_REPLY';
const UPDATE_COMMENT = 'games/UPDATE_COMMENT';
